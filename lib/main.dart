 ...
 final CartListBloc bloc=BlocProvider.getBloc<CartListBloc>();
  ...
  Widget build(BuildContext context) {
    ...
    builder: (context,snapshot){
           ...
           //"دا بتاع الرقم اللي في ايقونة الكاريت"
           int length= foodItems!=null?foodItems.length:0;
           //"دا بقا ايقونة الكاريت"
           return buildCestorDecator(length,context,foodItems);
    },
    )
        ],
      ),
  ...
  GestureDetector buildCestorDecator(int length, BuildContext context, List<FoodItem> foodItems) {
  return GestureDetector(
    onTap: (){
...
child:  Container(
  ...
  //"اللينث اللي هنا بقا متعرف فاوبجيكت في الكلاس اللي فوق اللي هوا طول الليستا"
